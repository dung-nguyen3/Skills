...
**Template Files:**
- `/templates-and-examples/Excel_Drugs_Chart_11-1.txt` - Excel template reference
- `/templates-and-examples/Word_LO_11-5.txt` - Word template reference
- `/templates-and-examples/Drug_Chart_HTML.txt` - HTML drug chart template
- `/templates-and-examples/HTML_LO_Master_Chart.txt` - HTML LO template

**Color Reference:**
- `/templates-and-examples/Light_Pastel_Color_Samples.xlsx` - Color palette
