...
examples:
  - <example>User runs: /excel --merge "HIV-PIs.txt;HIV-NRTIs.txt;HIV-NNRTIs.txt"
  ...
  - <example>User runs: /clinical --merge "Lower-Back.txt;Spine.txt;Neuro.txt" "Back Pain"
...
1. User runs: `/excel --merge "f1.txt;f2.txt;f3.txt"`
