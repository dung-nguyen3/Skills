...
```
/create-excel [source-file]     - Creates Excel Drug Chart
/create-word [source-file]      - Creates Word LO Guide
/create-drug-html [source-file] - Creates HTML Drug Chart
/create-lo-guide [source-file]  - Creates HTML LO Guide
```
